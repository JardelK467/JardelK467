...
🌱 Currently: becoming more full-stack. Kotlin Multiplatform on the front, Go on the back.<br>
⚙️ Learning concurrency in Go by building: goroutines, channels, and knowing when not to use them.

**What I'm working on**

🧱 Software fundamentals and systems thinking: APIs, MCP<br>
🤖 Agent orchestration and AI-integrated apps<br>
🎥 Media handling<br>
💛 Emotional design in UI and UX

📝 [jardelkerr.dev](https://jardelkerr.dev)<br>
